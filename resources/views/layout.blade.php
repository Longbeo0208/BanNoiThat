...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Shop Bán Đồ Nội Thất</title>
	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="{{URL::to('/contact')}}"><span class="icon-envelope"></span> Liên hệ</a>
...
<div class="row">
	<div class="span4">
	<h1>
	<a class="logo" href="{{URL::to('/trangchu')}}"><span>Nội Thất VIP</span> 
		<img src="{{asset('public/frontend/images/Logo.jpg')}}" alt="Logo">
	</a>
	</h1>
	</div>
	<div class="span4">
...
<div class="row-fluid">
<div class="span2">
<h5>“Đặt sự hài lòng của khách hàng là ưu tiên số 1 trong mọi suy nghĩ hành động của mình” 
	là sứ mệnh, là triết lý, chiến lược...</h5>
 </div>
<div class="span2">
...
<div class="span2">
<h5>VỀ NỘI THẤT HÙNG ĐỨC</h5>
<a href="#">Giới thiệu</a><br>
<a href="#">Liên Hệ</a><br>
...
<a href="#">Hệ thống cửa hàng</a><br>
 ...
 <div class="span6">
<h5>THÔNG TIN VỀ CHỦ SỠ HỮU </h5>

Của Hàng : 8 Phạm Văn Bạch, Phường 15, Quận Tân Bình, Thành Phố Hồ Chí Minh.<br>
Xưởng Sản Xuất <br>

Xưởng: Hố Nai 3, Huyện Trảng Bom, Đồng Nai.<br>
Zalo : 0390128836<br>
 </div>
 </div>
</footer>
...
<div class="container">
	...
	<span><h4>Thành Trung &copy; 2022 </h4><br> <h4>Thông tin liên hệ: <br> </h4>
	<h5><p><i class="fa fa-phone-square" aria-hidden="true" style="font-size:22px;" &#038;nbsp=""></i> <a style="color:blue">Hotline</a> : 19003320</p></h5>
	<h5><p><i &#038;nbsp="" class="fa fa-envelope" aria-hidden="true" style="font-size:20px;"></i><a style="color:blue"> Email</a> : thanhtrung123@gmail.com</p></h5>
